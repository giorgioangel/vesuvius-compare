# slightly modified (https://github.com/tomhsiao1260/ThaumatoAnakalyptor-learn/blob/main/ThaumatoAnakalyptor/surface_detection.py) (Yao Hsiao)
...
def surface_detection(volume, global_reference_vector, blur_size=3, sobel_chunks=4, sobel_overlap=3, window_size=20, stride=20, threshold_der=0.1, threshold_der2=0.001):
    ...
    mask = (second_derivative.abs() < threshold_der2) & (torch.abs(first_derivative) > threshold_der)
    ...
    return mask, coords, coords_normals